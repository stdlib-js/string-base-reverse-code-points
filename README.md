...
```javascript
import reverseCodePoints from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base-reverse-code-points@v0.2.3-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/string-base-reverse-code-points/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/string-base-reverse-code-points/actions/workflows/test.yml?query=branch:v0.2.3
